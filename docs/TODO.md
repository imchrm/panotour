...
- [ ] **U.1** История сцен Back/Forward: стек посещённых сцен в store
...
- [ ] **U.2** Ресайз левой панели: драг за правую кромку (невидимая зона захвата ~6px),
...
- [ ] **U.4** Запоминание положения камеры per-scene в сессии редактора:
